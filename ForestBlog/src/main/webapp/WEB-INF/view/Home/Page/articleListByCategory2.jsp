...
<rapid:override name="title">
	<title>${categoryCustom.categoryName} | ${options.optionSiteTitle}</title>
</rapid:override>
				...
				<c:choose>
					<c:when test="${articleListVoList.size()!=0}">
						...
						<c:forEach items="${articleListVoList}" var="a">
							...
							<article class="post02">
				
								<figure class="thumbnail" style="float: none;width: 100%;max-width: 100%;height: 185px;margin:0">
									<a href="/article/${a.articleCustom.articleId}" width="100%" > 
									<img  src=" ${a.articleCustom.articleImg}" style="width:100%;height:100%; max-width: 100%;min-height: 180px;max-height: 180px;"
...
<!-- 								<br> -->
								...
								<header class="entry-header2" style="margin-bottom: 5px">
									<h2 class="entry-title" style="white-space:nowrap;overflow: hidden;text-overflow: ellipsis;">
										<a href="/article/${a.articleCustom.articleId}" rel="bookmark" > ${a.articleCustom.articleTitle} </a>
									</h2>
								</header>
								<!-- .entry-header -->

								 <div class="entry-content2" style="height: 50px;overflow: hidden;text-overflow: ellipsis;margin-bottom: 5px">
								...
								<a href="/article/${a.articleCustom.articleId}" rel="bookmark" style="position: inherit;bottom: 0px;right: 0px;">详情 </a>
								</span>
							</article>
						</c:forEach>
						<%--文章列表-end--%>
		...
		</c:choose> </main><br><br><br><br><br><br><br><br><br><br>
		<c:choose>
			<c:when test="${articleListVoList!=null}">
				<c:if test="${articleListVoList.size()!=0}">
					<%--分页 start--%>
					<nav class="navigation pagination" role="navigation" style="width: 100%;margin-right: 0px;">
						<div class="nav-links">
							<c:choose>
							...
							<c:choose>
								...
								<c:otherwise>
									<a class="page-numbers" href="/category/${articleListVoList[0].categoryCustomList[0].categoryId}/p/${articleListVoList[0].page.pageNow-1}"> <span
