					...
					<c:when test="${articleListVoList.size()!=0}">
						...
						<c:forEach items="${articleListVoList}" var="a">
							...
							<article class="post" data-wow-delay="0.3s">
								...
								<div class="entry-content">
									...
									<span class="title-l"></span> <span class="new-icon"> <c:choose>
											...
											&nbsp;&nbsp;
												...
												class="fa fa-comment-o"></i> <c:choose>
								...
								<span class="entry-more"><a href="/article/${a.articleCustom.articleId}" rel="bookmark">阅读全文</a></span>
							</article>
						</c:forEach>
						<%--文章列表-end--%>
					</c:when>
					...
					<nav class="navigation pagination" role="navigation">
						<div class="nav-links">
							...
							<c:choose>
								...
								<c:otherwise>
									<a class="page-numbers" href="/tag/${articleListVoList[0].tagCustomList[0].tagId}/p/${articleListVoList[0].page.pageNow-1}"> <span
